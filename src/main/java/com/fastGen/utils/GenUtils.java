package com.fastGen.utils;

import com.fastGen.entity.ColumnEntity;
import com.fastGen.entity.TableEntity;
...
public class GenUtils {
    ...
    /**
    * @Description:  获取配置拓展类模板
    * @Param: []
    * @Return: java.util.List<java.lang.String>
    * @Date: 2020/5/9
    */
    public static List<String> getConfigTemp(){
        List<String> templates = new ArrayList<String>();
        templates.add("template/Swagger2Configuration.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.example" : mainPath;
        //封装模板数据
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.vue.vm" )) {
            return "src" + File.separator+"main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" +
